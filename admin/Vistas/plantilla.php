...
<head>
  ...
  <title>Administración | HotelZone</title>
  ...
  <script src="https://kit.fontawesome.com/3c3ae75314.js" crossorigin="anonymous"></script>
</head>
    ...
    if (isset($_SESSION["Ingreso"]) && $_SESSION["Ingreso"] == true) {
       ...
       include "modulos/menu.php";
        ...
        if (isset($_GET["url"])) {
          ...
          if ($_GET["url"] == "inicio" || $_GET["url"] == "ingreso" || $_GET["url"] == "salir" || $_GET["url"] == "usuarios" || $_GET["url"] == "perfil" || $_GET["url"] == "slide" || $_GET["url"] == "nosotros" || $_GET["url"] == "servicios" || $_GET["url"] == "galeria" || $_GET["url"] == "galeria" || $_GET["url"] == "hsimple" || $_GET["url"] == "hdoble" || $_GET["url"] == "htriple" || $_GET["url"] == "hsuite" || $_GET["url"] == "mensajes" || $_GET["url"] == "suscriptores") {
